...
/* Example for free fall detection */
...
void bmi160_task(void *pvParameters)
{
    ...
    ESP_LOGI(TAG, "Example for free fall detection");
    ...
    bmi160_free_fall_conf_t freeFallConf =
    {
        .freeFallTh = BMI160_FREE_FALL_TH_0_00781G,
        .freeFallHy = BMI160_FREE_FALL_HY_0_25G,
        .freeFallDur = BMI160_FREE_FALL_DUR_20MS
    };

    ESP_ERROR_CHECK(bmi160_enable_free_fall_detection(&bmi160_dev, &freeFallConf));
    ...
    bmi160_enable_int_free_fall(&bmi160_dev, &intOutConf);
